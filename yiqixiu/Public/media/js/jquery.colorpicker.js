 ...
 * 
 * @author    
 * @url    http://www.ablanxue.com/uploadfile/201405/13991726640845889/ablanxue/index.html
...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<table width=253 id="CT" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="000000"  style="cursor:pointer;">'
            +colorTable+'</table>';
