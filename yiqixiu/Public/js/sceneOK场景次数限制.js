                        ...
                        register: function(a) {
                            ...
                            return c.then(function(a) {
                                if (200 === a.data.code) {
                                    ...
                                    window.location.href='http://test.souho.net';
                                } else {alert("账号已经存在！")}
                            }, function() {
                                w.isAuthenticated()
                            })
