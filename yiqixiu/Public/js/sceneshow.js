...
! function($) {
    ...
    function parseJson(a) {
        ...
        var b = a.list,
            ...
            d = !1,
            e = a.obj.image;
        if (b.length <= 0) return alert("此场景不存在"), void(window.location.href = "http://test.souho.net");
        customLastPage = !1, appendLastPage(a, b), bindShare(a), document.title = a.obj.name, $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由搜虎精品社区免费移动场景应用自营销管家提供技术支持"), $(".scene_title").html(a.obj.name);
