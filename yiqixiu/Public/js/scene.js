...
! function(a, b, c) {
    ...
    b.module("app", ["ngRoute", "home", "sample", "main", "reg", "scene", "my", "data", "error", "usercenter", "ui.bootstrap", "ui.grid", "ui.grid.selection", "ngSanitize", "ui.select", "services.i18nNotifications", "services.httpRequestTracker", "services.sample", "security", "app.upload", "templates-app", "templates-common", "ui.sortable", "I18N.MESSAGES", "app.directives.notification"]), b.module("app").config(["$routeProvider", "$locationProvider", "securityAuthorizationProvider", "uiSelectConfig",
            ...
            function(b, c, d, e, f, g) {
                ...
                var v = {},
                    w = {
                        ...
                        thirdPartyUrl: {
                            weiChatUrl: "https://open.weixin.qq.com/connect/qrconnect?appid=wxc5f1bbae4bb93ced&redirect_uri=http%3A%2F%2Ftest.souho.net&response_type=code&scope=snsapi_login&state=STATE#wechat_redirect",
                            qqUrl: "https://graph.qq.com/oauth2.0/authorize?response_type=token&client_id=101149132&redirect_uri=http%3A%2F%2Ftest.souho.net&scope=get_user_info",
                            weiboUrl: "https://api.weibo.com/oauth2/authorize?client_id=3508809852&response_type=token&redirect_uri=http://test.souho.net"
                        },
        ...
        function() {
            ...
            function(a) {
                a.put("footer.tpl.html", '<footer>\n	<div class="content_center">\n		<article class="footer">\n				<p>\n				<img ng-src="{{CLIENT_CDN}}images/logo.png">\n				      		<a target="_blank" href="javascript:void(0);">加入我们</a>|<a target="_blank" href="javascript:void(0);">意见反馈</a>|<a target="_blank" href="javascript:void(0);">内容举报</a>|<a target="_blank" href="javascript:void(0);">关于我们</a>|<a href="javascript:void(0);">论坛</a> ©2015 <a href="http://test.souho.net">test.souho.net</a>. All rights reserved\n        	</p>\n        </article>\n	</div>\n</footer>')
            }
