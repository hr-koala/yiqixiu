(function(a) {
    a.fn.slider = function(b) {
        ...
        return this.each(function() {
            var h = a(this);
            var k = h.find(".slides-container");
            var r = h.find(".slides-container li");
            var i = h.find(".slide-switch");
            var m = h.find(".slide-switch li");
            var e = h.find(".slides-bg li");
            var q = h.find(".slide-shortcut-next");
            var g = h.find(".slide-shortcut-prev");
            var f = r.length;
            var p = 0;
            var j = 0;
            s();
